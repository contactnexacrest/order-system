 ...
 * content for the five internal document_types rows (CHECKLIST,
 * SOP_A_SALES, SOP_B_SALES, STAGEGATE, WALLREF) that existed only as
 * unused rows before this. One row per document_type_id, not per-order —
 * these apply company-wide, not to any single order.
 */
