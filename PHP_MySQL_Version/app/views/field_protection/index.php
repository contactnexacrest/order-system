      ...
      <tr>
        ...
        <td>
          ...
          <?php else: ?>
            ...
            <form method="post" action="/admin/field-protection/<?= (int) $r['id'] ?>/reject" style="display:inline" onsubmit="return confirm('Reject this unlock request? The field stays protected.');">
              <?= Csrf::field() ?>
